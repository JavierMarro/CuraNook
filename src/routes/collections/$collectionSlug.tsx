...
import { getCollectionBySlug, getCollectionArtworks } from "@/db/db";
      ...
      {artworks.length === 0 ? (
        ...
        <div className="artworks-grid mb-5">
          {artworks.map((artwork) => (
            <div
              key={artwork.id}
              className="border rounded-lg shadow-lg overflow-hidden bg-white hover:shadow-xl transition-shadow"
            >
