...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-screen flex-col items-center justify-center overflow-hidden w-full rounded-b-md z-0",
        className
      )}
    >
  ...
  "
      ...
      <div className="relative z-50 flex -translate-y-45 xs:-translate-y-55 sm:-translate-y-20 md:-translate-y-20 lg:portrait:-translate-y-82 lg:landscape:-translate-y-22 xl:-translate-y-25 2xl:-translate-y-45 flex-col items-center px-5">
        {children}
      </div>
    </div>
  );
