...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative rounded-full border border-transparent bg-cyan-900/91 backdrop-blur-xs shadow-input flex justify-center space-x-10 md:space-x-15 xl:space-x-15 px-8 py-5 -mt-2 "
    >
      {children}
    </nav>
  );
